# Multi-Plugin Deployment Script - Fixed Version
...
Write-Host "=== Multi-Plugin Deployment (Fixed) ===" -ForegroundColor Green
    ...
    if (Test-Path $sourcePath) {
        ...
        if ($LASTEXITCODE -eq 0) {
            ...
            if ($plugin.activate) {
                ...
                Write-Host "  o Not activated (per configuration)" -ForegroundColor Gray
            }
        } 
        else {
        ...
        Write-Host "  x Source not found: $sourcePath" -ForegroundColor Red
    }
}
